...
INSERT INTO airports (code, name, domain, cost, briefing_text, evidence_content, fragment_name) VALUES
...
-- -----------------------------------------------
INSERT INTO teams (name, login_code, credits_balance, clearance_tier) VALUES
('Alpha Squad', 'TEST-ALPHA-123', 60, 'ALPHA'),
('Bravo Six', 'TEST-BRAVO-456', 45, 'BRAVO'),
('Charlie Team', 'TEST-CHARLIE-789', 35, 'CHARLIE'),
('Delta Force', 'TEST-DELTA-000', 0, NULL);
